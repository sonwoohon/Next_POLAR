...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.log('[API][POST /api/chats/messages] 요청 데이터:', { message, contactRoomId, senderId });
    ...
    console.log('[API][POST /api/chats/messages] 메시지 생성 성공 - 실시간 이벤트 발생 예상');
    console.log('[API][POST /api/chats/messages] contact_messages 테이블에 INSERT 이벤트 발생');
    console.log('[API][POST /api/chats/messages] Supabase Realtime이 이 이벤트를 구독자들에게 전송해야 함');
